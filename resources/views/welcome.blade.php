...
<body>
  ...
  <header class="hero">
    <div class="container spacing">
      <h1 class="primary-title">Spécial fête des meres chez Polaris</h1>
      <p>-20% sur une large sélection d'articles dame jusqu'au 30/05/2021</p>
      <a href="https://www.facebook.com/Polaris.tn" class="btn">A DÉCOUVRIR !</a>
    </div>
  </header>
  ...
  <main>
    ...
    <section class="our-products">
      <div class="container">
        <h2 class="section-title">Ventes Flash</h2>
